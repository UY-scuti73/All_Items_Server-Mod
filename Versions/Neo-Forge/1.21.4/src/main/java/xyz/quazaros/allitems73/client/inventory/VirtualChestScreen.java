...
public class VirtualChestScreen extends Screen {
    ...
    private void renderBackgroundTexture(GuiGraphics guiGraphics) {
        guiGraphics.blit(RenderType::guiTextured, TEXTURE, guiLeft, guiTop, 0, 0, BACKGROUND_WIDTH, BACKGROUND_HEIGHT, 256, 256);
    }
    ...
    private void renderProgress(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        if (mouseX >= x && mouseX < x + 16 && mouseY >= y && mouseY < y + 16) {
            guiGraphics.renderComponentTooltip(this.font,
                    List.of(Component.literal("Progress: " + main.getItemList().getProgString()).withStyle(ChatFormatting.AQUA)),
                    mouseX, mouseY);
        }
    }
    ...
    private void renderLeaderboard(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        if (mouseX >= x && mouseX < x + 16 && mouseY >= y && mouseY < y + 16) {
            guiGraphics.renderComponentTooltip(this.font, main.getItemList().getLeaderboard(), mouseX, mouseY);
        }
    }
    ...
    private void renderFilter(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        if (mouseX >= x && mouseX < x + 16 && mouseY >= y && mouseY < y + 16) {
            guiGraphics.renderComponentTooltip(this.font,
                    List.of(Component.literal("Filter").withStyle(ChatFormatting.AQUA)),
                    mouseX, mouseY);
        }
    }
    ...
    private void renderScrollbar(GuiGraphics guiGraphics) {
        ...
        guiGraphics.blitSprite(RenderType::guiTextured, tex, x, knobY, SCROLLBAR_WIDTH, KNOB_HEIGHT);
    }
