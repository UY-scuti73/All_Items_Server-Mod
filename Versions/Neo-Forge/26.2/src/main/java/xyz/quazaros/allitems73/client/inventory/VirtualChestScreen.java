...
public class VirtualChestScreen extends Screen {
    ...
    private void renderSlotsAndItems(GuiGraphicsExtractor guiGraphics) {
    ...
    private void drawTitle(GuiGraphicsExtractor guiGraphics) {
        guiGraphics.text(this.font, this.title, guiLeft + 8, guiTop + 6, 0xFF404040, false);
    }
    ...
    private void renderProgress(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
        int x = guiLeft + SLOT_OFFSET_X + SLOT_SIZE * 2;
        int y = guiTop + SLOT_OFFSET_Y + VISIBLE_ROWS * SLOT_SIZE + 4;
        guiGraphics.item(new ItemStack(Items.DIAMOND), x, y);
    ...
    private void renderLeaderboard(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
        int x = guiLeft + SLOT_OFFSET_X + SLOT_SIZE * 4;
        int y = guiTop + SLOT_OFFSET_Y + VISIBLE_ROWS * SLOT_SIZE + 4;
        guiGraphics.item(new ItemStack(Items.OAK_HANGING_SIGN), x, y);
    ...
    private void renderFilter(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
        int x = guiLeft + SLOT_OFFSET_X + SLOT_SIZE * 6;
        int y = guiTop + SLOT_OFFSET_Y + VISIBLE_ROWS * SLOT_SIZE + 4;
        guiGraphics.item(new ItemStack(Items.HOPPER), x, y);
    ...
    private void renderScrollbar(GuiGraphicsExtractor guiGraphics) {
        Identifier tex = canScroll() ? KNOB_TEXTURE : KNOB_TEXTURE_DISABLED;
